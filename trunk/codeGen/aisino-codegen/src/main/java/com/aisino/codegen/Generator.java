...
import com.aisino.codegen.util.AntPathMatcher;
import com.aisino.codegen.util.BeanHelper;
import com.aisino.codegen.util.FileHelper;
import com.aisino.codegen.util.FreemarkerHelper;
import com.aisino.codegen.util.GLogger;
import com.aisino.codegen.util.GeneratorException;
import com.aisino.codegen.util.IOHelper;
import com.aisino.codegen.util.StringHelper;
import com.aisino.codegen.util.ZipUtils;
...
public class Generator  {
	...
	private String includes = GeneratorProperties.getProperty(GeneratorConstants.GENERATOR_INCLUDES); // 需要处理的模板，使用逗号分隔符,示例值: java_src/**,java_test/**
	private String excludes = GeneratorProperties.getProperty(GeneratorConstants.GENERATOR_EXCLUDES); // 不需要处理的模板，使用逗号分隔符,示例值: java_src/**,java_test/**
