...
import com.trent.core.common.exception.CoreException;
...
public class JsonUtil {
	...
	public static String toJson(Object obj) {
		try {
			...
			throw new CoreException("OrderRequest.toJson error", e);
		}
	}
	...
	public static <T> T fromJsonToObject(String body, Class<T> clazz) {
		try {
			...
			throw new CoreException("OrderRequest.fromJsonToOrderRequest error", e);
		}
	}
}
