...
//									);
	...
	public static void main(String[] args) {
		...
		String[] str = {"id","name","age","class"};
		System.out.println(qlBuilder.toSQLIn(str));;
		
		List<String> list = new ArrayList<String>();
		list.add("id");
		list.add("name");
		list.add("age");
		System.out.println(qlBuilder.toSQLIn(list));
		
		LinkedHashMap<String, String> map = new LinkedHashMap<String, String>();
		map.put("id", "desc");
		map.put("name", "asc");
		System.out.println(qlBuilder.buildOrderby(map));
		
		System.out.println(qlBuilder.buildSelect(str, "g"));
		
		System.out.println(qlBuilder.buildSelect("Student", str, "t"));  
	}
}
